...
VIM_MAKEFILE_DIR=$(VIM_MAIN_DIR)build/
...
OBJS=\
	...
	$(VIM_OBJS_DIR)__/__/test/unit/fixtures/rbuffer.c.o \
	$(VIM_OBJS_DIR)__/__/test/unit/fixtures/multiqueue.c.o \
	...
	$(VIM_OBJS_DIR)api/private/validate.c.o \
